...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <div
      className="profile-card my-10  mx-10 w-[275px] rounded-md shadow-xl overflow-hidden  relative cursor-pointer snap-start shrink-0 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 "
    >

      <div
        className="avatar w-full pt-5 flex items-center justify-center flex-col gap-1"
      >
        <div className="w-full h-[65px] bg-blue-500 absolute top-0">
      ...
      <hr
        className="w-full  h-3 bg-blue-500"
      />
    </div>
